...
<div class="row">
	<div class="col-3">
		<div class="card">
			...
			<img class="card-img-top" src="<?php echo theme_url('images/avatar-default.png');?>" alt="Card image cap">
			<?php } else { ?>
			<img class="card-img-top" src="<?php echo theme_url($user['avatar']);?>" alt="Card image cap">
			<?php }?>
