		...
		<div class="row">
			<div class="col s12">
				<ul class="tabs" style="border-bottom:1px solid #ececec">
					<li class="tab col s2"><a target="_self" <?php if($loop == "all"){echo "class='active'";} ?> href="<?php echo URL::route('posts.index') ?>">Todas</a></li>
					<li class="tab col s2"><a target="_self" <?php if($loop == "trash"){echo "class='active'";} ?> href="<?php echo URL::route('posts.trash') ?>">Lixeira</a></li>
				</ul>
			</div>
		</div>
